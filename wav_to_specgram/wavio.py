...
def _wav2array(nchannels, sampwidth, data):
    ...
    nchannels: number of channels in the audio signal
    sampwidth: number of bytes used to represent each sample (usually 2 (16-bit) or 3 (24-bit))
    """
...
def readwav(file):
    ...
    data = wav.readframes(nframes)  # Returns a byte array
    wav.close()
    array = _wav2array(nchannels, sampwidth, data)
    return rate, sampwidth, nchannels, array
